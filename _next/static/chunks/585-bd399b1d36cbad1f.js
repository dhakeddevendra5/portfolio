  ...
  [585],
  {
            ...
            for (
              ...
              (e = (function () {
                var e = f(),
                  n = y(i);
                if (n) {
                  if ((E(), !y(o))) return g("property missing ':'");
                  var r = y(a),
                    s = e({
                      type: "declaration",
        ...
        (t.default = function (e, t) {
          ...
          for (var u in e) {
            ...
            if (f) {
              ...
              switch (
                (o.includes(f) && a.includes(t) && !c && (f = s("default" + d)),
                (n[f] = p),
                h && h.type)
              ) {
                case r.BOOLEAN:
            ...
            i.PRESERVE_CUSTOM_ATTRIBUTES && (n[u] = p);
          }
        ...
        s = (e, t) => {
          let n = (0, r.forwardRef)((n, a) => {
            ...
            return (0, r.createElement)(l, {
              ref: a,
              iconNode: t,
              className: o("lucide-".concat(i(e)), s),
              ...c,
            });
          });
    ...
    5227: function (e, t, n) {
      ...
      var i = n(3045),
        ...
        l = { reactCompat: !0 };
      (t.PRESERVE_CUSTOM_ATTRIBUTES = Number(i.version.split(".")[0]) >= 16),
    ...
    5579: (e, t) => {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        (t.CARRIAGE_RETURN = "\r"),
        (t.CARRIAGE_RETURN_REGEX = RegExp(t.CARRIAGE_RETURN, "g")),
        (t.CARRIAGE_RETURN_PLACEHOLDER =
          "__HTML_DOM_PARSER_CARRIAGE_RETURN_PLACEHOLDER_".concat(
            Date.now(),
            "__"
          )),
        (t.CARRIAGE_RETURN_PLACEHOLDER_REGEX = RegExp(
          t.CARRIAGE_RETURN_PLACEHOLDER,
          "g"
        ));
    },
    ...
    6017: (e, t) => {
      ...
      t.camelCase = function (e, t) {
        var c;
        return (void 0 === t && (t = {}), !(c = e) || i.test(c) || n.test(c))
          ? e
          : ((e = e.toLowerCase()),
        ...
        (t.default = function e(t, n) {
          ...
          for (
            var r = [],
              ...
              s = n.transform || a.returnFirstArg,
              c = n.library || l,
              u = c.cloneElement,
              p = c.createElement,
              d = c.isValidElement,
            ...
            if (i) {
              var y = n.replace(g, h);
              if (d(y)) {
                f > 1 && (y = u(y, { key: y.key || h })), r.push(s(y, g, h));
                continue;
              }
            }
            if ("text" === g.type) {
              ...
              if (
                (v && g.parent && !(0, a.canTextBeChildOfNode)(g.parent)) ||
                (n.trim && v)
              )
                continue;
              r.push(s(g.data, g, h));
            ...
            a.PRESERVE_CUSTOM_ATTRIBUTES &&
              "tag" === m.type &&
              (0, a.isCustomComponent)(m.name, m.attribs))
              ? ((0, a.setStyleProp)(g.attribs.style, g.attribs),
                (E = g.attribs))
              : g.attribs && (E = (0, o.default)(g.attribs, g.name));
            var b = void 0;
            switch (g.type) {
              case "script":
              case "style":
                g.children[0] &&
                  (E.dangerouslySetInnerHTML = { __html: g.children[0].data });
                break;
              case "tag":
                "textarea" === g.name && g.children[0]
                  ? (E.defaultValue = g.children[0].data)
                  : g.children && g.children.length && (b = e(g.children, n));
                break;
              default:
                continue;
            }
            f > 1 && (E.key = h), r.push(s(p(g.name, E, b), g, h));
          }
    ...
    6661: (e, t, n) => {
      ...
      let { CAMELCASE: l, SAME: s, possibleStandardNames: c } = n(5888),
        u = RegExp.prototype.test.bind(
          RegExp(
            "^(data|aria)-[:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040]*$"
          )
        ),
        p = Object.keys(c).reduce((e, t) => {
          let n = c[t];
          return (
            n === s
              ? (e[t] = t)
    ...
    7238: (e, t, n) => {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.formatAttributes = o),
        (t.escapeSpecialCharacters = function (e) {
          return e.replace(
            i.CARRIAGE_RETURN_REGEX,
            i.CARRIAGE_RETURN_PLACEHOLDER
          );
        }),
        (t.revertEscapedCharacters = a),
        (t.formatDOM = function e(t, n, l) {
          void 0 === n && (n = null);
          for (var s, c = [], u = 0, p = t.length; u < p; u++) {
            var d = t[u];
            switch (d.nodeType) {
              case 1:
                var f = (function (e) {
                  var t,
                    n =
                      ((t = e = e.toLowerCase()),
                      i.CASE_SENSITIVE_TAG_NAMES_MAP[t]);
                  return n || e;
                })(d.nodeName);
                (s = new r.Element(f, o(d.attributes))).children = e(
                  "template" === f ? d.content.childNodes : d.childNodes,
                  s
                );
                break;
              case 3:
                s = new r.Text(a(d.nodeValue));
                break;
              case 8:
      ...
      function a(e) {
        return e.replace(
          i.CARRIAGE_RETURN_PLACEHOLDER_REGEX,
          i.CARRIAGE_RETURN
        );
      }
    },
    ...
    8183: function (e, t, n) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        (t.default = function (e, t) {
          ...
          return e
            ? (0, a.default)(
                (0, i.default)(e, (null == t ? void 0 : t.htmlparser2) || s),
                t
              )
            : [];
        });
    ...
    8605: (e, t, n) => {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.default = function (e) {
          var t,
            n,
            f = (e = (0, i.escapeSpecialCharacters)(e)).match(s),
            h = f && f[1] ? f[1].toLowerCase() : "";
          switch (h) {
            case o:
              var m = d(e);
              if (!c.test(e)) {
                var g = m.querySelector(a);
                null === (t = null == g ? void 0 : g.parentNode) ||
                  void 0 === t ||
                  t.removeChild(g);
              }
              if (!u.test(e)) {
                var g = m.querySelector(l);
                null === (n = null == g ? void 0 : g.parentNode) ||
                  void 0 === n ||
                  n.removeChild(g);
              }
              return m.querySelectorAll(o);
            case a:
            case l:
              var y = p(e).querySelectorAll(h);
              if (u.test(e) && c.test(e)) return y[0].parentNode.childNodes;
              return y;
            default:
              if (r) return r(e);
              var g = p(e, l).querySelector(l);
              return g.childNodes;
          }
        });
      var r,
      ...
      if ("object" == typeof document && document.implementation) {
        ...
        p = function (e, t) {
          if (t) {
            var n = m.documentElement.querySelector(t);
            return n && (n.innerHTML = e), m;
          }
          return (m.documentElement.innerHTML = e), m;
        };
      }
      var g = "object" == typeof document && document.createElement("template");
      g &&
        g.content &&
        (r = function (e) {
