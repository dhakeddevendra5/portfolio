  ...
  [23],
  {
    523: (e, r, o) => {
      ...
      let t = (e) => {
          ...
          return {
            getClassGroupId: (e) => {
              let o = e.split("-");
              return (
                "" === o[0] && 1 !== o.length && o.shift(), n(o, r) || s(e)
              );
            },
        ...
        i = (e, r, o, t) => {
          e.forEach((e) => {
            ...
            if ("function" == typeof e) {
              ...
              r.validators.push({ validator: e, classGroupId: o });
              return;
            }
        ...
        b = (e) => {
          let { separator: r, experimentalParseClassName: o } = e,
            t = 1 === r.length,
            n = r[0],
            l = r.length,
            s = (e) => {
        ...
        g = (e) => ({ cache: u(e.cacheSize), parseClassName: b(e), ...t(e) }),
        m = /\s+/,
        h = (e, r) => {
          let {
              parseClassName: o,
      ...
      let U = (function (e, ...r) {
        ...
        let l = function (a) {
          return (
            (t = (o = g(r.reduce((e, r) => r(e), e()))).cache.get),
            (n = o.cache.set),
            (l = s),
            s(a)
          );
        ...
        return function () {
          return l(x.apply(null, arguments));
        };
      })(() => {
        let e = w("colors"),
          r = w("spacing"),
        ...
        return {
          ...
          theme: {
            ...
            gradientColorStopPositions: [_, E],
            inset: P(),
            margin: P(),
            opacity: X(),
            padding: W(),
          ...
          classGroups: {
            ...
            grow: [{ grow: U() }],
            shrink: [{ shrink: U() }],
            order: [{ order: ["first", "last", "none", I, O] }],
            "grid-cols": [{ "grid-cols": [D] }],
            "col-start-end": [{ col: ["auto", { span: ["full", I, O] }, O] }],
            "col-start": [{ "col-start": F() }],
            "col-end": [{ "col-end": F() }],
            "grid-rows": [{ "grid-rows": [D] }],
            "row-start-end": [{ row: ["auto", { span: [I, O] }, O] }],
            ...
            w: [
              { w: ["auto", "min", "max", "fit", "svw", "lvw", "dvw", O, r] },
            ],
            "min-w": [{ "min-w": [O, r, "min", "max", "fit"] }],
            "max-w": [
              {
                "max-w": [
                  O,
            ...
            h: [
              { h: [O, r, "auto", "min", "max", "fit", "svh", "lvh", "dvh"] },
            ],
            "min-h": [
              { "min-h": [O, r, "min", "max", "fit", "svh", "lvh", "dvh"] },
            ],
            "max-h": [
              { "max-h": [O, r, "min", "max", "fit", "svh", "lvh", "dvh"] },
            ],
            size: [{ size: [O, r, "auto", "min", "max", "fit"] }],
            "font-size": [{ text: ["base", R, E] }],
            ...
            "text-decoration-thickness": [
              { decoration: ["auto", "from-font", N, E] },
            ],
            "underline-offset": [{ "underline-offset": ["auto", N, O] }],
            ...
            "outline-offset": [{ "outline-offset": [N, O] }],
            "outline-w": [{ outline: [N, E] }],
            "outline-color": [{ outline: [e] }],
            "ring-w": [{ ring: A() }],
            "ring-w-inset": ["ring-inset"],
            "ring-color": [{ ring: [e] }],
            "ring-opacity": [{ "ring-opacity": [h] }],
            "ring-offset-w": [{ "ring-offset": [N, E] }],
            "ring-offset-color": [{ "ring-offset": [e] }],
            shadow: [{ shadow: ["", "inner", "none", R, B] }],
            ...
            contrast: [{ contrast: [i] }],
            "drop-shadow": [{ "drop-shadow": ["", "none", R, O] }],
